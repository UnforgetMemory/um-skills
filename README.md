...
| [umrelease](umrelease/SKILL.md) | Automated GitHub Release publishing: runs CI dry-run build+test gate (no publish) until success, then creates git tag and publishes via `gh release create` — with professional concise English release notes, security-audited for internal details, and manual confirmation before publishing. |
