...
3. 其余 L0 延迟加载：`references/context-adaptation.md` 到 Phase 0 档位自检；`references/project-memory.md`/`references/artifact-routing.md` 到 P0 记忆与产物扫描；`references/subagent-orchestration.md` 到首次分派
...
| P2 | 工程规格：Architecture/Module Impact/Risk/Dependencies/Test Strategy | references/architecture-principles.md · references/component-roles.md · references/modern-architecture.md | read | 架构评审 |
