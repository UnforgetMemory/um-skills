...
3. 其余 L0 延迟加载：`references/context-adaptation.md` 到 Phase 0 档位自检；`references/subagent-orchestration.md` 到波次分派；`references/project-memory.md` 到 P7 私货对照
...
| P7 | 私货扫描：对照 .um.agents/constraints/ 查未申报修改/硬编码后门 | references/project-memory.md | grep/read | 违规标记 |
