# Conventional Commits 与原子提交规范

调用 skill：`conventional-commits`（完整规范以该 skill 为准，本文档为执行清单）
...
提交前按 [security-audit.md](security-audit.md) 的「## 2. Commit 审计」执行 Hard Block 扫描。
